...
function DrawerOverlay({ className, ...props }: React.ComponentProps<typeof DrawerPrimitive.Overlay>) {
  return <DrawerPrimitive.Overlay className={cn("app-drawer-overlay fixed inset-x-0 top-0 z-[60] bg-black/70 backdrop-blur-[3px]", className)} {...props} />;
}
  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        className={cn("app-drawer-content fixed inset-x-0 z-[70] mx-auto flex max-h-[90vh] max-w-lg flex-col rounded-t-[24px] border-t border-line-strong bg-s1 outline-none", className)}
